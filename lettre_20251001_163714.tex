...
\titleformat{\section}
  {\large\bfseries\color{black}} % Default color, overridden by *colored commands below
  {}
  {0pt}
  {}[\vspace{-0.2cm}\rule{\textwidth}{2pt}]
\titlespacing*{\section}{0pt}{15pt}{0pt}

% Colored section commands
\newcommand{\ProfileSection}[0]{\section*{\textcolor{blue}{Profile}}}
\newcommand{\EducationSection}[1]{\section*{\textcolor{red}{Education}}}
