...
\usepackage{titlesec}
\usepackage{tcolorbox} % ✅ Added for rounded colored boxes
...
% ==== Section commands with same style ====
...
% ==== Header ====
{\Huge\bfseries AZIZ BELHADJ SAYAR}\\[10pt]
{\fontsize{18pt}{18pt}\selectfont Computer Science Student}\\
