...
% ==== Photo ====
% ==== Photo (Right-side corners rounded) ====
\begin{textblock*}{3.5cm}(16.5cm,0.83cm)
\begin{tcolorbox}[
    colback=white,
    colframe=white,
    boxrule=0pt,
    ...
    sharp corners=north west,
    sharp corners=south west,
    clip, % <- important, this clips the content (image) to the shape
]
\includegraphics[width=3.5cm,height=3.5cm]{Profil-removebg.png}
\end{tcolorbox}
\end{textblock*}
